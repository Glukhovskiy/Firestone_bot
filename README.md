...
- **Map Missions** - Выполнение миссий на карте с приоритизацией по типам
...
```json
"MissionPriorities": {
  "scout": 1,     // Разведка - высший приоритет
  "adventure": 2, // Приключения - средний приоритет
  "war": 3        // Война - низший приоритет
}
```
...
2. **Map Missions** - Сбор активных наград и запуск новых миссий по приоритетам
...
- **Map Missions**: Миссии запускаются по приоритету типов (scout > adventure > war)
